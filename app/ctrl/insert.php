...
if ($_SESSION['tipo'] == 'A') { //Solo entra si es administrador.
...

	{
		...
		if ($hayError) {
			...
			$oferta = array();
			$oferta = crearOferta($_POST['desc'], $_POST['per_cont'], $_POST['tlf_cont'], $_POST['email_cont'], $_POST['dir'], $_POST['pb'], $_POST['cp'], $_POST['provincia'], $_POST['estado'], formatoFecha($_POST['fcom']) , $_POST['psico'], $_POST['cand'], $_POST['anotaciones']);
